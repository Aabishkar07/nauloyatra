            ...
            <div class="hero-main">
                <div class="package-header">
                    <div class="package-meta">
                        <span class="package-type">{{ $travelPackage->tour_type }}</span>
                    ...
                    <p class="package-subtitle">Discover {{ $travelPackage->package_name }}</p>
                    ...
                    <div class="gallery-thumbs">
                        <div class="gallery-thumb">
                            @if ($travelPackage->image_2 != "")
                                <img src="{{ asset('image/uploads/travelPackage/'.$travelPackage->image_2) }}" alt="Gallery 2">
                            @else
                        ...
                        <div class="gallery-thumb">
                            @if ($travelPackage->image_3 != "")
                                <img src="{{ asset('image/uploads/travelPackage/'.$travelPackage->image_3) }}" alt="Gallery 3">
                            @else
            ...
            <aside class="booking-sidebar">
                <div class="booking-card">
                    <div class="booking-header">
                        ...
                        <p>Payment after invoice review • Free cancellation 24h</p>
                    </div>
