...
class TravelPackageController extends Controller
{
    ...
    {
        $travelPackages = travelPackage::orderBy('created_at', 'DESC')->take(8)->get();
        $latestPackages = travelPackage::orderBy('created_at', 'DESC')->take(5)->get();
        $latestBlogs = Blog::orderBy('created_at', 'DESC')->take(3)->get();
        return view('user.home', compact('travelPackages', 'latestPackages', 'latestBlogs'));
    }
